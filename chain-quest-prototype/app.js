...
class LLMServiceAdapter {
  ...
  static buildSystemPrompt(nodeConfig, scenario, isMandarin = false) {
    const rolePersonas = {
      ...
      "同學阿明": "活潑直率的同班死黨，講話帶點白眼吐槽與幽默打鬧感，愛開玩笑，重視當下的真實觀察與同儕互損。",
    ...
    return [
      ...
      `     * 【動物園第 5 關 (展區觀察 - 同學阿明白眼吐槽與精簡台詞)】：核心目標是說出大象/獅子/蛇的真實外觀或動作特徵。若學生夾帶無厘頭垃圾話、開玩笑或只注意大便等奇葩細節，判定 isMatch: true；阿明不要生硬附和，直接以死黨口吻翻白眼吐槽奇葩點，再拉回動物特徵！NPC 台詞嚴格控制在 1~2 句短句（25~35 字內），嚴禁長篇科普解說。`,
