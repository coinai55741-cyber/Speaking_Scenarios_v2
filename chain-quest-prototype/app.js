  ...
  hakka_food: {
    ...
    nodes: {
      food_step1: {
        ...
        objectPosition: "50% 50%",
        storyPrompt: "你走近一間熱鬧的客家小吃店，穿客家服飾的男店員站在門口招呼你。你感受到飢腸轆轆的肚子在大叫，準備點一份餐點。你說：",
        mandarinStoryPrompt: "你走近一間熱鬧的傳統小吃店，男店員站在門口招呼你。你感受到飢腸轆轆的肚子在大叫，準備點一份餐點。你說：",
      ...
      food_step3: {
        ...
        targetHakka: "這碗湯粄條當好食，恁仔細老闆娘！",
        targetMandarin: "這道粄條真好吃，謝謝老闆娘！",
        keywords: ["當好食", "好食", "恁仔細", "老闆娘", "太鹹", "不喜歡", "無好食", "香菜", "香菜味", "結帳"],
        mandarinKeywords: ["真好吃", "好吃", "謝謝老闆娘", "謝謝", "不好吃", "不喜歡", "有點鹹", "太鹹", "滿意", "很飽", "香菜", "香菜味", "不要香菜", "交代", "味道", "結帳", "買單"],
        altKeywords: ["好吃", "好食", "當好食", "很好吃", "真好吃", "不好吃", "毋好食", "當不好食", "不喜歡", "太鹹", "有點鹹", "不滿意", "香菜", "香菜味", "有香菜", "味道", "不要香菜", "謝謝", "恁仔細", "結帳", "買單", "收錢", "五十元", "五十箍"],
        npcRole: "老闆娘",
        npcAvatar: "👩‍🍳",
        npcSuccessResponse: "「謝謝你說出感覺！一共是五十元，很高興合你的胃口，歡迎下次再來喔！」",
        mandarinNpcSuccessResponse: "「謝謝你說出感覺！一共是五十元，很高興合你的胃口，歡迎下次再來喔！」",
        npcRetryResponse: "「老闆娘拿著帳單親切問：『吃飽準備結帳囉！今天餐點吃得習慣嗎？可以跟老闆娘分享你的感覺喔！』」",
        mandarinNpcRetryResponse: "「老闆娘拿著帳單親切問：『吃飽準備結帳囉！今天餐點吃得習慣嗎？可以跟老闆娘分享你的感覺喔！』」",
        nextNodeId: null
      }
    }
  },
  ...
  health_center: {
    ...
    nodes: {
      ...
      health_rest: {
        ...
        storyPrompt: "護理師細心幫你照護完後，叮嚀你今天不要勉強運動，要多喝水好好休息。你答應她並道謝。你說：",
        mandarinStoryPrompt: "護理師細心幫你照護完後，叮嚀你今天不要勉強運動，要多喝水好好休息。你答應她並道謝。你說：",
        targetHakka: "𠊎會多啉水、好好歇睏，恁仔細護理師！",
        targetMandarin: "我會多喝水、好好休息，謝謝護理師！",
        keywords: ["多啉水", "歇睏", "恁仔細", "護理師"],
        mandarinKeywords: ["多喝水", "喝水", "好好休息", "休息", "謝謝護理師", "謝謝"],
        altKeywords: ["喝水", "多喝水", "溫水", "多啉水", "休息", "好好休息", "歇睏", "謝謝", "謝謝護理師", "恁仔細", "護理師", "阿姨", "不要運動", "不運動"],
        npcRole: "護理師",
        npcAvatar: "👩‍⚕️",
        npcSuccessResponse: "「真懂事！先在病床上躺著休息一節課，身體很快就會恢復元氣囉！」",
        mandarinNpcSuccessResponse: "「真懂事！先在病床上躺著休息一節課，身體很快就會恢復元氣囉！」",
        npcRetryResponse: "「護理師叮嚀：『阿姨幫你處理好囉，今天不要劇烈運動，要答應阿姨多喝水好好休息喔！』」",
        mandarinNpcRetryResponse: "「護理師叮嚀：『阿姨幫你處理好囉，今天不要劇烈運動，要答應阿姨多喝水好好休息喔！』」",
        nextNodeId: null
      }
    }
  },
...
class LLMServiceAdapter {
  ...
  static buildSystemPrompt(nodeConfig, scenario, isMandarin = false) {
    const rolePersonas = {
      "售票員": "親切幽默又有同理心的動物園售票阿姨，負責核對購票人數與發售票券，熱心宣傳三人同行活動，幽默不能忍受拋下落單朋友，堅守票務規定但親切風趣。",
    ...
    return [
      ...
      `       - 【情境與活動動機】：園區今天正好有「三人同行大探索/學生三人同行闖關優惠活動」。售票員是位幽默熱心的阿姨。`,
      `       - 【當學生只說買 1~2 張、少買或想把落單朋友丟在外面等時 (未通過 isMatch: false)】：`,
      `         * 【嚴禁生硬硬套推銷邏輯】（絕對嚴禁說出『外面等的同學也買一張下次用』等怪異不合常理的話）！`,
      `         * 售票員必須用「幽默人情味吐槽 + 宣傳活動」親切力揪大家一起進去玩：`,
      `           👉 參考話術：「哎唷同學～你們三個好朋友一起來，怎麼忍心把落單的朋友丟在門口吹西北風餵蚊子啦！而且今天園區剛好有『三人同行闖關活動』，三個人一起進去才熱鬧！你再跟阿姨說一次，要買幾張學生票呀？」`,
      ...
      `     * 【客家小吃店第 3 關 (結帳評價)】：核心目標是用餐完畢後在收銀櫃檯說出評價（稱讚好吃或給予建議反饋）並完成結帳買單。老闆娘必須站在收銀結帳角色禮貌回應評價並收錢找零（五十元/五十箍），【嚴禁再出現『菜馬上來』或推銷菜單】！`,
      ...
      `     * 【健康中心第 3 關 (休息道謝)】：核心目標是答應遵照醫囑多喝水好好休息並禮貌道謝。`,
      ...
      `       - 【特殊情況 (若學生說要陪阿婆一起走/我跟你一起走)】：若學生說『我跟你一起走』、『阿嬤你跟我一起走就好啦我陪你慢慢走我們都一樣是去市立圖書館』或『我帶你去』但未說明具體路線，判定 isMatch: false，阿婆誇獎懂事並親切引導（避免過度指導位置，自然詢問『你會不會看指針呢？』）：`,
      `         * 變體1（想學看地圖自己走）：『哎唷～小朋友你真貼心！不過阿婆想學看地圖自己走，你指著地圖跟我說說看，我們要先往哪個方向走、去哪裡呢？你會不會看指針呢？』`,
      `         * 變體2（長輩走路慢）：『哎唷～小朋友你人真好、真貼心！不過阿婆走路比較慢，你指著地圖跟阿婆說，我們要先往哪個方向走、去哪裡呢？你會不會看指針呢？』`,
      `       - 【未通過/方向不明時 (isMatch: false)】：阿婆親切以看懂指北針引導學生，【嚴禁直接講出『向北走』破哏】：『小朋友，阿婆我看得懂地圖喔，以前有學過看指北針！你看著地圖，你會不會看指針呢？從這裡是要往哪一個方向走、去哪裡呢？你再看著指針跟阿婆說一次好嗎？』。`,
      ...
      ``,
      `2. 【關鍵規則 — 符合目標但夾帶情緒/告狀/抱怨/玩笑/題外話時的雙向回應 (Dual-Response)】：`,
      `   - 若學生發言「已達成核心任務」，但夾帶了情緒宣洩、抱怨同學、告狀、開玩笑、題外話或特殊要求（例如白痴小明推我、大象好臭、問廁所、要禮物、開玩笑）：`,
      `     * 【判定】：isMatch: true（核心任務已達成，一律給予通過）！`,
      `     * 【NPC 對話 (dynamicNpcResponse)】：NPC 必須 100% 站在自身角色人設，同時處理核心任務並安撫/回應題外話：`,
      `       - 🦁【售票員】（學生：『我要買三張學生票，售票員你長得好像猩猩喔！』）➔ 售票員：『哈哈哪有！猩猩可沒我這麼會算票喔！這是你們的三張學生票，快進去看看真正的猩猩吧！』`,
      `       - 🦁【志工奶奶】（學生：『這是門票謝謝奶奶，但我現在好想上廁所快憋不住了！』）➔ 奶奶：『好懂事門票收好囉！別急別急，進大門右手邊直走就是洗手間，快去吧！』`,
      ...
      `       - 🏥【保健室護理師】（學生：『我的左腳這邊流血了剛剛白痴小明推我害我跌倒』）➔ 護理師：『哎呀膝蓋流血破皮一定很痛吧！別生氣先在椅子上坐好，阿姨先幫你消毒擦藥。小明推你的事阿姨等下會跟老師說，先深呼吸放輕鬆喔！』`,
      ...
      `   - 若學生發言「尚未達成核心任務」（例如只買2張要丟下1人在外面等、只問打折卻沒說買幾張票、只問推薦卻沒點菜、點了小吃店沒賣的紅龜粿或牛排）：`,
      `     * 【判定】：isMatch: false。`,
      `     * 【NPC 對話 (dynamicNpcResponse)】：NPC 根據學生說的話做出真實生動的情境引導與回絕，引導他完成本關目標！`,
      `       - 🦁【售票員（少買票/留人在外）】（學生：『阿姨我想要買兩張學生票，其中一個人沒有要進去他在外面等。』）➔ 售票員：『哎唷同學～你們三個人一起來，把落單的朋友丟在門口吹西北風餵蚊子太可憐了啦！而且今天剛好有三人同行活動，三個人一起進去才熱鬧！你再跟阿姨說一次，要買幾張學生票？』`,
...
class SpeechService {
  ...
  static evaluateAnswer(userTranscript, nodeConfig, isMandarinMode = false) {
    ...
    const isOfferingToWalkTogether = nid === "bus_arrive" && /一起走|帶你去|帶你行|陪你走|陪你行|跟我走|跟我行|帶阿婆|帶阿嬤|陪阿婆|陪阿嬤|陪你慢慢走|跟我一起走/.test(normalizedCleanText);
    if (nid === "bus_arrive" && isOfferingToWalkTogether && !(/北方|北邊|向北|往北|東方|東邊|向東|往東|紅綠燈|右轉|左轉|越倒手|正手邊/.test(normalizedCleanText))) {
      isMatch = false;
    }
    ...
    } else if (nid === "bus_arrive" && isOfferingToWalkTogether && !isMatch) {
      customNpcResponse = isMandarinMode
        ? "「哎唷～小朋友你真貼心！不過阿婆想學看地圖自己走，你指著地圖跟我說說看，我們要先往哪個方向走、去哪裡呢？你會不會看指針呢？」"
        : "「哎唷～細妹仔/細倈仔你正經當貼心！毋過阿婆想學看地圖仰般自家行，你比等地圖摎阿婆講，𫣆俚愛先向哪一個方向行、去哪位呢？你曉得看指針無？」";
      feedbackMsg = "阿婆很稱讚您的貼心，但她想學習看地圖自己走，請看著地圖指針說明走法喔！";
...
class UIController {
  ...
  renderStepTracker(scenario, currentNode) {
    ...
    if (scenario.id === "zoo_chain") {
      ...
      visibleSteps.push({ id: "food_step1", title: "步驟 1：進入店家點餐" });
  ...
  renderSpeechNode(node) {
    ...
    if (node.id === "health_rest") {
      ...
      if (branchId === "health_symptom_scratch") {
        promptText = "傷口包紮好後，護理師叮嚀你今天不要劇烈運動，要多喝水好好休息。你答應她並道謝。你說：";
