  ...
  bus_directions: {
    ...
    nodes: {
      bus_choose_dest: {
        ...
        npcRetryResponse: "「路人關心問：『同學，你看起來有點困惑，是不是迷路了或找不到公車呀？你要去文化園區、學校還是圖書館呢？告訴我我來幫你看！』」",
        mandarinNpcRetryResponse: "「路人關心問：『同學，你看起來有點困惑，是不是迷路了或找不到公車呀？你要去文化園區、學校還是圖書館呢？告訴我我來幫你看！』」",
        choices: [
          {
            id: "culture",
            title: "🏛️ 文化園區",
  ...
  health_center: {
    ...
    nodes: {
      health_choose_symptom: {
        ...
        keywords: ["頭那痛", "擦傷", "身體當燒"],
        mandarinKeywords: ["頭痛肚子痛", "膝蓋擦傷", "身體發熱"],
        altKeywords: ["頭痛", "肚子痛", "頭那痛", "肚痛", "擦傷", "跌倒", "膝蓋", "發熱", "發燒", "身體熱"],
        npcRole: "護理師",
        npcAvatar: "👩‍⚕️",
        ...
        choices: [
          ...
          },
          {
            ...
            keywords: ["擦傷", "跌倒", "膝蓋", "跑太遽", "腳痛", "流血", "痛痛"],
            mandarinKeywords: ["擦傷", "跌倒", "膝蓋", "流血", "破皮", "跑太快", "腳痛"],
...
class LLMServiceAdapter {
  ...
  static buildSystemPrompt(nodeConfig, scenario, isMandarin = false) {
    ...
    return [
      ...
      `     * 【搭車問路第 1 關 (向路人詢問目的地公車路線)】：核心目標是學生向公車站旁的路人開口詢問想去的目的地（文化園區/學校/圖書館）要搭哪一路公車。路人 NPC 必須扮演「熱心助人的市民」，看到學生在站牌前猶豫張望，應以親切關心、詢問是否迷路或找不到車的口吻引導（例：『同學，你看起來有點困惑，是不是迷路了或找不到公車呀？你要去哪裡，我來幫你看！』），【嚴禁】像導遊或觀光推銷員般說『我可以幫你介紹公車路線』！`,
      ...
      `       - 例5【保健室護理師】（學生：『護理師我頭好痛肚子也一直拉，下午可以不用上課嗎？』）：護理師回應：『辛苦了！先躺在病床上休息一節課量體溫，如果還是很不舒服再幫你聯絡導師喔！』`,
