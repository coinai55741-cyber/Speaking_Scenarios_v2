...
class LLMServiceAdapter {
  ...
  static buildSystemPrompt(nodeConfig, scenario, isMandarin = false) {
    ...
    return [
      ...
      `       - 【特殊情況 (若學生說要陪阿婆一起走/我跟你一起走)】：若學生說『我跟你一起走』、『阿嬤你跟我一起走就好啦我陪你慢慢走我們都一樣是去市立圖書館』或『我帶你去』但未說明具體路線，判定 isMatch: false，阿婆誇獎懂事並親切引導（可使用以下兩種親切回應之一）：`,
      `         * 變體1（想學看地圖自己走）：『哎唷～你真懂事、還這麼貼心想陪阿婆走！不過阿婆也想學看地圖怎麼自己走，你指著地圖跟我說說看怎麼走，我學起來下次就可以自己去囉！你看地圖上的指針是要往哪個方向走呢？』`,
...
class SpeechService {
  ...
  static evaluateAnswer(userTranscript, nodeConfig, isMandarinMode = false) {
    ...
    if (askingForRecommendation) {
      ...
      customNpcResponse = isMandarinMode
        ? "「哎唷～你真懂事、還這麼貼心想陪阿婆走！不過阿婆也想學看地圖怎麼自己走，你指著地圖跟我說說看怎麼走，我學起來下次就可以自己去囉！你看地圖上的指針是要往哪個方向走呢？」"
        : "「哎唷～你真乖、還恁體貼想陪阿婆行！毋過阿婆乜想學看地圖仰般自家行，你比等指針摎阿婆講愛仰般行，𠊎學起來下次就做得自家去囉！你看指針係愛向哪一個方向行呢？」";
