  ...
  health_center: {
    ...
    nodes: {
      ...
      health_symptom_head: {
        ...
        npcRole: "護理師",
        npcAvatar: "👩‍⚕️",
        npcSuccessResponse: "「我知道了，阿姨幫你量體溫，倒一杯溫開水給你喝喔。」",
        mandarinNpcSuccessResponse: "「我知道了，阿姨幫你量體溫，倒一杯溫開水給你喝喔。」",
...
class LLMServiceAdapter {
  ...
  static buildSystemPrompt(nodeConfig, scenario, isMandarin = false) {
    ...
    return [
      ...
      `     * 【健康中心第 2 關 (詳細說明具體症狀)】：核心目標是詳細描述具體病徵與原因（頭暈肚子痛 / 體育課跑步跌倒膝蓋擦傷破皮流血 / 身體發熱全身無力）。`,
